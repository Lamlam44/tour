...
public interface TouristDestinationMapper {
     ...
     */
    TouristDestinationResponseDTO touristDestinationToResponseDTO(TouristDestination touristDestination);
    ...
    TouristDestination touristDestinationRequestDTOToTouristDestination(TouristDestinationRequestDTO requestDTO);
